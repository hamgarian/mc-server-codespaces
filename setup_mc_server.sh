...
sudo apt-get install -y openjdk-17-jdk curl jq
...
# Fetch latest Minecraft server jar URL using Mojang version manifest
...
echo -e "${GREEN}Installing Playit.gg tunnel agent...${NC}"
curl -O https://playit-cloud.github.io/agent/installer.sh
